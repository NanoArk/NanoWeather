...
public class LoadLibs {
   ...
   public static final String            TESS4J_TEMP_DIR  = new File(
      System.getProperty("java.io.tmpdir"), "tess4j").getPath();
   /**
    * Native library name.
    */
   ...
   static {
      ...
      File targetTempFolder = extractTessResources("win32-" + System.getProperty("os.arch"));
